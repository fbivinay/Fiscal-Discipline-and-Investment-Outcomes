...
%       references .................................. tools/pagecount.py verifies
...
%   Section headings centred, bold, 12pt ............. \titleformat below
...
Figure~\ref{fig:region} shows the problem directly. The four groups separate
along the debt axis almost without overlap: the two western states hold the
low-debt, high-FDI corner, the three southern states sit beside them, and the
northern and eastern states occupy the high-debt end. A line fitted through these
ten points is a debt line and a region line at once, and nothing in the figure
tells them apart.

\begin{figure}[H]
\centering
\includegraphics[width=0.86\textwidth]{figures/fig01_region.pdf}
\caption{Five-year mean debt against five-year mean log FDI, by region.}
\label{fig:region}
\end{figure}
