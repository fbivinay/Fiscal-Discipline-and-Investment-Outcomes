...
fig.suptitle("Fiscal Discipline Indicators, Top-10 FDI States (FY2019-20 to FY2023-24)",
...
ax.set_title("Five-Year FDI Equity Inflows by State\n(UP total understated — recorded only from FY2021-22)")
...
ax.set_title("Fiscal Deficit vs FDI (5-year averages)\nColour = debt level; note Jharkhand as outlier")
...
ax.set_title("Fiscal Discipline Rank by Year (1 = most disciplined)")
...
ax.set_title("The COVID Fiscal Shock — 10-State Averages")
...
ax.set_title("Year-wise FDI Inflows (log scale)\nNote Jharkhand's collapse after FY2020-21")
...
ax.set_title("GSDP Growth — COVID Dip and Recovery")
